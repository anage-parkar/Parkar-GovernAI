...
const breakpointSnippets = {
  muiBreakpoints: `// MUI default breakpoints (used in Parkar GovernAI)
  ...
  return (
    <Box sx={{ p: "32px 40px" }}>
      ...
      <Box sx={{ mb: "32px" }}>
        ...
        >
          Parkar GovernAI uses MUI's default breakpoint system. Use responsive sx props and useMediaQuery
